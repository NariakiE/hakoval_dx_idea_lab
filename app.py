...
PUBLIC_COPY_OVERRIDES_BY_TITLE = {
    "業者側の紙の日報をデジタル化（常用工事記入可能）": {
        ...
        "user_scene": "職長の田中さんは、作業員が帰る前後にスマホで人数、人工、常用工事、追加作業を入力し、元請へ承認依頼する。事務員の佐藤さんは、月末に紙を集めてコピー・転記する代わりに、未承認だけを確認して請求根拠として出力する。",
        ...
        "detail": (
            ...
            "- 事務員 佐藤さん: 月末の紙集め、コピー、転記を減らし、未承認だけ確認して請求根拠を出力できる。\n\n"
            "削減目安（初期仮説）:\n"
            "- 職長の日報記入: 10分 -> 3分/日\n"
            "- 事務員さんの月末集計: 半日 -> 1時間/月\n"
            "- 確認電話・根拠探し: 5件 -> 1件/月\n"
